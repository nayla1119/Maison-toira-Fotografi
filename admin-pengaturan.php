...
if (isset($_POST['update_web'])) {
    $nama_web = mysqli_real_escape_string($koneksi, $_POST['nama_web']);
    // Logika simpan atau tiruan berhasil
    $pesan = "<div class='alert-success'><i class='fa-solid fa-circle-check'></i> Pengaturan berhasil disimpan!</div>";
}
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Pengaturan - Admin Maison Étoira</title>
...
<body>
    ...
    <div class="admin-container">
        <aside class="sidebar">
            <div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active"><a href="admin-pengaturan.php"><i class="fa-solid fa-sliders"></i> Pengaturan</a></li>
                </ul>
            </div>
        ...
        <main class="main-content">
            ...
            <p style="color: var(--text-muted); margin: 5px 0 25px 0; font-size: 0.95rem;">Konfigurasi identitas nama studio dan alamat email korespondensi utama.</p>

            <div class="form-card">
                <h3 style="margin-top: 0; margin-bottom: 20px; font-size: 1.2rem; font-weight: 700; color: var(--text-main);">Identitas Website</h3>
                
                <?= $pesan; ?>
                
                <form action="" method="POST">
                    <label>Nama Studio / Website</label>
                    <input type="text" name="nama_web" value="Maison Étoira">
                    
                    <label>Email Kontak</label>
                    <input type="email" name="email_web" value="support@maisonetoira.com">
                    
                    <button type="submit" name="update_web">Simpan Perubahan</button>
                </form>
            </div>
        </main>
    </div>
