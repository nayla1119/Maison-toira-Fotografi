...
// Contoh: echo "Total Booking Selesai: " . $d_total['total'];

// Ambil riwayat transaksi selesai
...
<head>
    ...
    <title>Laporan Keuangan - Maison Étoira</title>
...
<body>
    ...
    <div class="admin-container">
        <aside class="sidebar">
            <div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active"><a href="admin-laporan.php"><i class="fa-solid fa-file-invoice-dollar"></i> Laporan</a></li>
        ...
        <main class="main-content">
            ...
            <p style="color: var(--text-muted); margin: 5px 0 25px 0; font-size: 0.95rem;">Ringkasan total omzet dan riwayat pemesanan pelanggan yang telah selesai.</p>

            <div class="stat-box">
                <small style="opacity: 0.8; font-size: 0.85rem; display: block; margin-bottom: 2px;">Total Pendapatan Bersih</small>
                <h3 style="margin: 0; font-size: 1.8rem; font-weight: 700; letter-spacing: -0.5px;">Rp <?= number_format($d_total['total'] ?? 0, 0, ',', '.'); ?></h3>
            </div>
