...
$query = mysqli_query($koneksi, "SELECT p.*, u.nama, u.email FROM photographers p JOIN users u ON p.id_user = u.id_user");
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Data Fotografer - Admin Maison Étoira</title>
...
<body>
    ...
    <div class="admin-container">
        <aside class="sidebar">
            <div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active"><a href="admin-fotografer.php"><i class="fa-solid fa-camera"></i> Fotografer</a></li>
        ...
        <main class="main-content">
            <h2>Daftar Tim Fotografer</h2>
            <p style="color: var(--text-muted); margin: 5px 0 0 0; font-size: 0.95rem;">Daftar seluruh mitra fotografer profesional yang terdaftar di sistem.</p>
            ...
            <div class="card-panel">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $row['id_fotografer']; ?></td>
                            <td><strong><?= htmlspecialchars($row['nama']); ?></strong></td>
                            <td><?= htmlspecialchars($row['email']); ?></td>
                            <td><span style="color: #f59e0b;">★</span> <?= $row['rating']; ?></td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
