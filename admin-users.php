...
$query = mysqli_query($koneksi, "SELECT * FROM users WHERE role = 'pelanggan' ORDER BY id_user DESC");
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Data User - Admin Maison Étoira</title>
...
<body>
    ...
    <div class="admin-container">
        <aside class="sidebar">
            <div>
                ...
                <ul class="menu-list">
                    ...
                    <li class="menu-item active"><a href="admin-users.php"><i class="fa-solid fa-users"></i> Data User</a></li>
        ...
        <main class="main-content">
            <h2>Data Pelanggan Maison Étoira</h2>
            <p style="color: var(--text-muted); margin: 5px 0 0 0; font-size: 0.95rem;">Manajemen data registrasi seluruh pelanggan aktif di platform.</p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= !empty($row['nomor_telepon']) ? htmlspecialchars($row['nomor_telepon']) : '-'; ?></td>
